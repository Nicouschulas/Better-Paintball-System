...
public class Checks {
	...
	public static boolean checkTodo(@NotNull BetterPaintballSystem plugin, @NotNull CommandSender jugador){
	...
	public static void checkearYModificar(@NotNull BetterPaintballSystem plugin, boolean primeraVez) {
