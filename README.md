...
## **❓ What is BPS?**
**Better Paintball System** is a minigame plugin where two teams face off in an intense snowball fight! Both teams start with a set amount of lives. Every time a player gets hit and defeated, their team loses a life. The first team to hit 0 lives loses the game.
